...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = ADDA_axi_dma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.6
 PARAMETER HW_INSTANCE = HDMI_OUTPUT_axi_vdma_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.8
 PARAMETER HW_INSTANCE = ADDA_axi_dma_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = AXI4_IO
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ADDA_AXI4_IO_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_switch
 PARAMETER DRIVER_VER = 1.2
 PARAMETER HW_INSTANCE = ADDA_axis_switch_0
END
